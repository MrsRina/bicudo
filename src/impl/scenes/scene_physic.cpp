...
void scene_physic::on_start() {
    ...
    rigid_object = new rigid2d(100.0f, 100.0f);
    rigid_object->current_pos = math::vec2(200, 200);
    rigid_object->previous_pos = math::vec2(200, 200);
...
void scene_physic::on_render() {
    ...
    draw::shape::circle(x, y, 200, material_shape);
}