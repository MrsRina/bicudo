...
struct draw {
	 ...
	 **/
	struct shape {
		static void rect(float x, float y, float w, float h, material &material_data);
		static void circle(float x, float y, float radius, material &material_data);
		static void add_color_to_mesh_material_rgba(util::color &color);
	};
