...
namespace bicudo {
	struct shader {
		...
		void set_uniform(std::string_view, int32_t) const;
		void set_uniform(std::string_view, bool) const;

		void set_uniform_vec4(std::string_view, const float*) const;
		void set_uniform_vec3(std::string_view, const float*) const;
		void set_uniform_vec2(std::string_view, const float*) const;

		void set_uniform_matrix4x4(std::string_view, const float*) const;
		void set_uniform_matrix3x3(std::string_view, const float*) const;
		void set_uniform_matrix2x2(std::string_view, const float*) const;
	};
