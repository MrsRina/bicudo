#include "bicudo/gpu/driver_impl.hpp"
...
void bicudo::driver_impl_manager::update_viewport_size(int32_t w, int32_t h) {
	...
	glViewport(0, 0, this->viewport_w, this->viewport_h);
}
...
void bicudo::driver_impl_manager::update_absoluute_surface_color(float b, float g, float b) {
